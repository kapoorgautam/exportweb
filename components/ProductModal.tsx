                ...
                <>
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="bg-white dark:bg-gray-900 w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden relative border border-white/10 flex flex-col md:flex-row max-h-[90vh]"
                        >
                            {/* Close Button */}
                            <button
                                onClick={onClose}
                            ...
                            <div className="md:w-1/2 p-8 relative overflow-hidden bg-gray-50 dark:bg-black/50 overflow-y-auto">
                                <div className={`absolute top-0 left-0 w-full h-2 bg-gradient-to-r ${product.gradient}`} />

                                <h2 className="text-4xl font-bold font-display mb-2 text-gray-900 dark:text-white">{product.name}</h2>
                            ...
                            <div className="md:w-1/2 p-8 bg-white dark:bg-gray-900 flex flex-col justify-center overflow-y-auto">
                                <div className="mb-6">
